...
/**
 * The skew a user can act on: the connected server runs an older Slingshot UI than
...
export function resolveVersionMismatch(
  ...
  return {
    ...
    hint: "Version mismatch. Update the Slingshot client and server to the same version.",
  };
}
