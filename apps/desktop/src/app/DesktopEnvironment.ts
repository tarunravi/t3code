...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.t3tools.slingshot.dev" : "com.t3tools.slingshot",
    ),
    linuxDesktopEntryName: isDevelopment ? "slingshot-dev.desktop" : "slingshot.desktop",
    linuxWmClass: isDevelopment ? "slingshot-dev" : "slingshot",
