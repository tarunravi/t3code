...
function getGnomeKeyringRemediationMessage(): string {
  return "Slingshot could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Slingshot.";
}

function getKWalletRemediationMessage(): string {
  return "Slingshot could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Slingshot.";
}
