// This file mostly exists because we want dev mode to say "Slingshot (Dev)" instead of "electron"
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "Slingshot (Dev)" : "Slingshot (Alpha)";
export const APP_BUNDLE_ID = isDevelopment
  ? `com.t3tools.slingshot.dev.${devBundleIdSuffix || "local"}`
  : "com.t3tools.slingshot";
